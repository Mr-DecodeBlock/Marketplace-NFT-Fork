...
exports.deleteUsuario = exports.postUsuario = exports.login = exports.validateUser = exports.getUsuarios = exports.resetPassword = void 0;
...
const validateUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { body } = req;
    const usuario = yield usuario_1.default.find({ metamaskId: body.id }).select('-password');
    if (!usuario) {
        res.status(404).json({
